...
Shader "examples/week 3/shader structure"
{
    ...
    Properties 
    {
        ...
        _Texture ("a texture", 2D) = "black" {} //if it has no texture and u want adding color to work, have it be black, if u want multiplying color to work, have it be white
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            //fixed -lowest precision... maybe color on a mobile game?
            //half -medium precision... recommended for color or something
            //float -highest precision... wanna use for uv's and coordinate systems
            ...
            struct Interpolators
            {
                ...
                float3 normal : TEXCOORD0;   // TEXCOORD0 is a high precision variable. there is a limit to the number of these you can have depending on target hardware. you can safely use up to 8 for most all hardware.
