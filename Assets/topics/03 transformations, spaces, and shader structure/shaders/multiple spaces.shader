        ...
        Pass
        {
            ...
            float4 frag (Interpolators i) : SV_Target
            {
                ...
                for(int i = 0; i < count; i++) {
                    ...
                    newUV = rotate2D(newUV,angle); // apply rotation to uv space
                   ...
                   // color += float3(newUV.x,0,newUV.y); //can see all the spaces shift with this
                ...
                //color += float3(uv.x,0,uv.y); //you can see that the main uv space doesn't move
