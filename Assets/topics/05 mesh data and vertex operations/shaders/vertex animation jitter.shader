Shader "examples/week 5/vertex animation jitter"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            //function that will return a random vector direction
            ...
            Interpolators vert (MeshData v)
            {
                ...
                float timeSeed = _seed;

                float3 rVec = rand_vec(v.vertex.xyz + round(_Time.y*_timeScale),timeSeed) * _displacement;
                v.vertex.xyz += rVec;
